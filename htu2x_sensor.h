...
#define HTU2X_MEASUR_TEMP_DELAY       10
#define HTU2X_MEASUR_HUMI                   0xF5
#define HTU2X_MEASUR_HUMI_DELAY       10
#define HTU2X_WRITE_USER_REG              0xE6
#define HTU2X_READ_USER_REG               0xE7
// Resolution: Humidity 11bit; Temperature 11bit; Delaytime 10ms is safe for both
#define HTU2X_RESOLUTION                      0b10000001
